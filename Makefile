...
# rm Cliente.o
	g++ -pthread -lpthread -o ClientSide src/Client.cpp src/MainClient.cpp -Wall -Werror -I lib

server: lib/Server.hpp
# g++ -g -c Servidor.cpp
# g++ -g -o ServerSide Servidor.o -Wall -Werror
# rm Servidor.o
	g++ -pthread -lpthread -o ServerSide src/Server.cpp src/Client.cpp src/MainServer.cpp -Wall -Werror -I lib
